    ...
    <div className="space-y-12 animate-fade-in">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {/* AI Mock Interview Card [cite: 81] */}
          <FeatureCard
            to="/ai-interview"
            icon={<Bot size={32} className="text-primary" />}
            title="AI Mock Interview"
            description="Start a new AI-powered practice session. Get instant feedback."
          />

          {/* Resume Analyzer Card [cite: 20] */}
          <FeatureCard
            to="/resume-analyzer"
          ...
          {/* Interview Scheduling Card [cite: 84] */}
          <FeatureCard
            to="/schedule" // TODO: Create this page
      ...
      <div>
        <h2 className="text-3xl font-semibold mb-6 text-text-main">
          Past Interview Reports [cite: 82]
        </h2>
              ...
              pastInterviews.map((interview) => (
                <li key={interview.id} className="p-6 flex justify-between items-center hover:bg-slate-700/50 transition-colors">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <Link 
                      to={`/report/${interview.id}`} // TODO: Create this route
